...
- A T5-based conditional generation model for clinical descriptions.
...
def plot_training_curves(epochs, train_losses, val_losses, clf_losses, gen_losses,
    ...
    # Only plot AUC if there are valid values
